...
var main = (function($) { var _ = {
	...
	initEvents: function() {
		...
		// Keyboard shortcuts.
			...
			// Ignore shortcuts within form elements.
				...
				_.$body.on('click', 'div.image', function(event) {
					_.visit();
				});
			...
			_.$thumbnails.children()
				.each(function() {
					...
					var	$this = $(this),
						...
						$hiddenLink = $this.children('.hiddenLink'),
						s;
	...
	switchTo: function(index, noHide) {
		...
		// Set Link Location
			console.log('newSlide', newSlide.link)
	...
	visit: function() {
		const link = _.slides[_.current].link
		if (link) {
